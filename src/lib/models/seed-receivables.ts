...
export const SEED_RECEIVABLES: ReceivableEntry[] = [
  ...
  { id: 'rcv-006', clientId: 'cli-010', month: '2025-12', amount: 2225, description: 'Monthly Subscription Fee + One-Time Training Cost', status: 'paid' },
  ...
  { id: 'rcv-010', clientId: 'cli-010', month: '2026-01', amount: 1125, description: 'Monthly Subscription Fee', status: 'invoiced' },
  { id: 'rcv-011', clientId: 'cli-016', month: '2026-01', amount: 3994, description: 'Zavis Pro Plan half yearly subscription + One-time Setup', status: 'invoiced' },

  // ===== February 2026 (dh10,547) =====
  ...
  { id: 'rcv-013', clientId: 'cli-010', month: '2026-02', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
  ...
  { id: 'rcv-017', clientId: 'cli-010', month: '2026-03', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
  { id: 'rcv-018', clientId: 'cli-007', month: '2026-03', amount: 3375, description: 'Quarterly Subscription Fee', status: 'pending' },
  { id: 'rcv-019', clientId: 'cli-009', month: '2026-03', amount: 10735, description: 'MLSC Invoice', status: 'pending' },
  ...
  { id: 'rcv-022', clientId: 'cli-010', month: '2026-04', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },

  // ===== May 2026 (dh5,172) =====
  { id: 'rcv-023', clientId: 'cli-010', month: '2026-05', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
  ...
  { id: 'rcv-027', clientId: 'cli-010', month: '2026-06', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
  ...
  { id: 'rcv-031', clientId: 'cli-010', month: '2026-07', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
  { id: 'rcv-032', clientId: 'cli-016', month: '2026-07', amount: 2994, description: 'Zavis Half Yearly Subscription', status: 'pending' },

  // ===== August 2026 (dh5,172) =====
  { id: 'rcv-033', clientId: 'cli-010', month: '2026-08', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
  { id: 'rcv-034', clientId: 'cli-017', month: '2026-08', amount: 4497, description: 'Elite Plan Subscription', status: 'pending' },

  // ===== September 2026 (dh10,197) =====
  ...
  { id: 'rcv-037', clientId: 'cli-010', month: '2026-09', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
  { id: 'rcv-038', clientId: 'cli-007', month: '2026-09', amount: 3375, description: 'Quarterly Subscription Fee', status: 'pending' },

  // ===== October 2026 (dh3,097) =====
  { id: 'rcv-039', clientId: 'cli-001', month: '2026-10', amount: 2422, description: 'Quarterly Subscription Fee', status: 'pending' },
  { id: 'rcv-040', clientId: 'cli-010', month: '2026-10', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },

  // ===== November 2026 (dh5,172) =====
  { id: 'rcv-041', clientId: 'cli-010', month: '2026-11', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
  { id: 'rcv-042', clientId: 'cli-017', month: '2026-11', amount: 4497, description: 'Elite Plan Subscription', status: 'pending' },

  // ===== December 2026 (dh10,197) =====
  ...
  { id: 'rcv-045', clientId: 'cli-010', month: '2026-12', amount: 675, description: 'Monthly Subscription 3 Seats', status: 'pending' },
